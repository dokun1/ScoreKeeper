...
gpg --quiet --batch --yes --decrypt --passphrase="${ENCRYPTION_KEY}" --output ./ScoreKeeperCreds/Profiles/Distribution/ScoreKeeperAdHocProvisioningProfile.mobileprovision ./ScoreKeeperCreds/Profiles/Distribution/ScoreKeeperAdHocProvisioningProfile.mobileprovision.gpg
...
cp ./ScoreKeeperCreds/Profiles/Distribution/ScoreKeeperAdHocProvisioningProfile.mobileprovision ~/Library/MobileDevice/Provisioning\ Profiles/ScoreKeeperAdHocProvisioningProfile.mobileprovision
